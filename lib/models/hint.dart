...
const techniqueDifficulty = <HintTechnique, Difficulty>{
  // Bronze / Silver are generated by given-count alone (see
  // [SudokuGenerator]); their bands here only label a finished puzzle's
  // hardest technique, they don't gate generation.
  ...
  HintTechnique.intersectionPointing: Difficulty.easy,
  HintTechnique.intersectionClaiming: Difficulty.easy,
  // Gold: the pair subsets. A Locked Pair IS a naked pair that happens to
  // sit in a box/line intersection, so it shares the tier.
  HintTechnique.lockedPair: Difficulty.medium,
  HintTechnique.nakedPair: Difficulty.medium,
  HintTechnique.hiddenPair: Difficulty.medium,
  // Diamond: the triple subsets, the single-digit fish/chains, and the
  // basic bivalue wings.
  ...
  HintTechnique.xWing: Difficulty.hard,
  HintTechnique.skyscraper: Difficulty.hard,
  HintTechnique.twoStringKite: Difficulty.hard,
  HintTechnique.turbotFish: Difficulty.hard,
  HintTechnique.xyWing: Difficulty.hard,
  HintTechnique.remotePair: Difficulty.hard,
  // Master: the 3-cover fish, the compound wings, single-digit colouring,
  // the finned/sashimi fish, and the quad subsets.
  ...
  HintTechnique.simpleColoring: Difficulty.master,
  HintTechnique.finnedXWing: Difficulty.master,
  HintTechnique.sashimiXWing: Difficulty.master,
  HintTechnique.nakedQuad: Difficulty.master,
  HintTechnique.hiddenQuad: Difficulty.master,
  // Challenger: uniqueness arguments, chains, and ALS.
  ...
  // Hint-only (absent from [humanSolverTechniqueOrder]), so these tiers
  // never actually classify a generated puzzle — but every technique needs
  // an entry, and Challenger is where they'd land if promoted.
