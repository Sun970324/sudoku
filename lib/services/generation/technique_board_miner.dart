...
/// practice queue. Unlike [mineTechniqueBoard]'s "take the fullest board a
/// technique happens to appear on", this digs each solved board *within the
/// category ceiling* down to the sparsest still-solvable form, so the result
/// is a real puzzle you work through with that category's ideas — e.g. a
/// Singles board is a genuine easy sudoku solvable by singles alone, not a
/// near-complete grid with one Full House. Returns null when [maxSeeds] is
/// exhausted (caller retries later).
