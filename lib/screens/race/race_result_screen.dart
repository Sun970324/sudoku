      ...
      builder: (context, _) {
        ...
        return GradientScaffold(
          appBar: AppBar(
              ...
              title: Text(l10n.raceResultTitle)),
          body: CelebrationOverlay(
            ...
            child: ListView(
              ...
              children: [
                Center(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style:
                          const TextStyle(fontFamily: 'Mulmaru', fontSize: 24),
                    ),
                    const SizedBox(height: 16),
                ...
                const SizedBox(height: 16),
                if (_difficultyResult != null)
                  _TechniqueCard(result: _difficultyResult!),
      ...
      child: Column(
        ...
        children: [
          ...
          if (result.highestTechnique != null) ...[
            const SizedBox(height: 8),
            Text(
                '${l10n.highestTechniqueLabel} ${result.highestTechnique!.label(context)}'),
          ],
